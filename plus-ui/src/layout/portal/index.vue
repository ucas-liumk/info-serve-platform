...
const usesOwnShell = computed(() => route.name === 'InfoTools');
</script>
...
.portal-layout {
  ...
  min-height: 100vh;
  background:
    linear-gradient(135deg, rgba(232, 205, 149, 0.24), transparent 34%),
    linear-gradient(180deg, #f7f8f6 0%, #eef3f2 46%, #f7f8fb 100%);
  color: #111827;
