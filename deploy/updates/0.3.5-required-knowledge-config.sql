-- info-serve v0.3.5 required-knowledge subject configuration
-- Run against PostgreSQL database: ry-cloud

CREATE TABLE IF NOT EXISTS rk_subject_group (
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_rk_subject_group_code ON rk_subject_group (tenant_id, group_code) WHERE del_flag = '0';
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_rk_subject_code ON rk_subject (tenant_id, subject_code) WHERE del_flag = '0';
CREATE INDEX IF NOT EXISTS idx_rk_subject_group ON rk_subject (tenant_id, group_id, status);
COMMENT ON TABLE rk_subject IS '应知应会学习科目';

CREATE TABLE IF NOT EXISTS rk_knowledge (
...
CREATE INDEX IF NOT EXISTS idx_rk_knowledge_subject ON rk_knowledge (tenant_id, subject_id, status, order_num);
...
UPDATE sys_menu SET order_num = 3 WHERE menu_id = 4001;
UPDATE sys_menu SET order_num = 4 WHERE menu_id = 4002;
UPDATE sys_menu SET order_num = 5 WHERE menu_id = 4003;

INSERT INTO sys_role_menu (role_id, menu_id)
SELECT DISTINCT rm.role_id, m.menu_id
FROM sys_role_menu rm
CROSS JOIN (VALUES (4004), (4005), (4011), (4012), (4013), (4014), (4015), (4021), (4022), (4023), (4024), (4031), (4032), (4033), (4034), (4035)) AS m(menu_id)
...
FROM sys_role_menu
WHERE menu_id IN (4004, 4005, 4011, 4012, 4013, 4014, 4015, 4021, 4022, 4023, 4024, 4031, 4032, 4033, 4034, 4035)
ON CONFLICT (role_id, menu_id) DO NOTHING;

INSERT INTO sys_role_menu (role_id, menu_id)
SELECT DISTINCT r.role_id, m.menu_id
FROM sys_role r
CROSS JOIN (VALUES (4000), (4004), (4005), (4011), (4012), (4013), (4014), (4015), (4021), (4022), (4023), (4024), (4031), (4032), (4033), (4034), (4035)) AS m(menu_id)
