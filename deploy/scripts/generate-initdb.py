...
def generate_nacos_update_sql() -> None:
    ...
    new_configs = ["ruoyi-portal.yml", "ruoyi-file.yml", "portal-requiredknowledge.yml", "portal-kernel.yml", "portal-forum.yml", "portal-resources.yml"]
...
def write_pg_business_db() -> None:
    ...
    extras = [
        "postgres_app_center.sql",
        "postgres_info_service.sql",
        "postgres_portal_kernel.sql",
        "postgres_required_knowledge.sql",
    ]  # 追加到 ry-cloud
